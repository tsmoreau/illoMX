...
// File: contracts/token/illoMXnfttoken.sol

/**
 * @title illoMX NFT Token
 * @author tsmoreau (https://github.com/tsmoreau)
 * @dev It is an ERC721Full with minter role and a struct that identify the gift
 */
contract illoMX is ERC721Full, Ownable {
  ...
  mapping(uint256 => URIUpdates) private tokenIdToURIUpdates;
  ...
  function createToken(string memory _tokenURI, bool _updateable) public returns (uint){
    ...
    tokenIdToURIUpdates[tokenId] = URIUpdates(
        tokenId,
        msg.sender,
        _tokenURI,
        _tokenURI,
  ...
  function isURIUpdateable()public{}
  
  function updateTokenURI()public{}
  
  function fetchChangesInTokenURI()public returns (uint){}
